        ...
        try {
            if(jwtFilter.isAdmin()) {
               ...
               if(!optional.isEmpty()) {
                   ...
                   return CafeUtils.getResponseEntity("User Status Has been changed", HttpStatus.OK);
               } else {
    ...
    public ResponseEntity<String> forgotPassword(Map<String, String> requestMap) {
        try {
            ...
            if (!Objects.isNull(user) && !Strings.isNullOrEmpty(user.getEmail())){
                emailUtils.forgotMail(user.getEmail(), "Credentials by admin", user.getPassword());
            }
